...
// oneStarRatings and threeStarRatings. Assign the threeStarRatings variable with a defaultvalue of 0.
...
// 2.1
// Destructure the first book object from the books array into variables
...
// object from the books array into a variable called tags. The tags variable
// should be assigned with the value of the keywords property.

const {keywords: tags} = books[0];
console.log("\ntags: ", tags);

// 2.3
// The seventh book from the books array is missing the programmingLanguage
// property. Destructure the seventh book object (books[6]) into variables
// called language and programmingLanguage. Assign the programmingLanguage
...
// called title, author and year. This function should work for a
// single object passed as an argument, and it should log to
// the console information about the book
